...
from PyQt5.QtCore import Qt, pyqtSignal, QThread, QPoint, QEvent, QTimer, QRect
from PyQt5.QtGui import QPixmap, QImage, QTouchEvent, QMouseEvent, QPainter, QFontMetrics
...
class PDFButton(QPushButton):
    ...
    def check_and_start_scroll(self):
        ...
        # Use boundingRect for compatibility
    ...
    def paintEvent(self, event):
        ...
        if self.text_width <= self.available_width:
            # Text fits, just center it or align left
            ...
            # Text doesn't fit, draw scrolling text
